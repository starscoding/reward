...
a=$("<div class='ui-jqgrid' style='left:10000px'><table class='ui-jqgrid-btable ui-sysmng-table' style='width:5px;'><tr class='jqgrow'><td style='width:5px;display:block;'></td></tr></table></div>"),b=a.appendTo("body").find("td").width();return a.remove(),Math.abs(b-5)>.1},isLocalStorage:function(){try{return"localStorage"in
...
c,d,f,g,h,j,k,o="<td class='ui-pg-button "+n+"'><span class='ui-separator'></span></td>",q="",s="<table class='ui-pg-table ui-sysmng-table ui-paging-pager'><tbody><tr>",t="",u=function(a,b){var
c;return"stop"!==(c=$(e).triggerHandler("jqGridPaging",[a,b]))&&($.isFunction(e.p.onPaging)&&(c=e.p.onPaging.call(e,a,b)),"stop"!==c&&(e.p.selrow=null,e.p.multiselect&&(e.p.selarrrow=[],Y(!1)),e.p.savedRow=[],!0))};if(a=a.substr(1),b+="_"+a,c="pg_"+a,d=a+"_left",f=a+"_center",g=a+"_right",$("#"+$.jgrid.jqID(a)).append("<div id='"+c+"' class='ui-pager-control' role='group'><table "+l(m,"pagerTable",!1,"ui-pg-table ui-sysmng-table ui-pager-table")+"><tbody><tr><td id='"+d+"' align='left'></td><td id='"+f+"' align='center' style='white-space:pre;'></td><td id='"+g+"' align='right'></td></tr></tbody></table></div>").attr("dir","ltr"),e.p.rowList.length>0){t='<td dir="'+i+'">',t+="<select "+l(m,"pgSelectBox",!1,"ui-pg-selbox")+' size="1" role="listbox" title="'+($.jgrid.getRegional(e,"defaults.pgrecs",e.p.pgrecs)||"")+'">';var
...
d,f,g='<ul id="column_menu" role="menu" tabindex="0">',h="",i="</ul>",j="",k=e.p.colModel[a],l=$.extend({sorting:!0,columns:!0,filtering:!0,seraching:!0,grouping:!0,freeze:!0},k.coloptions),m=$.jgrid.getRegional(e,"colmenu"),n=e.p.colNames[a],o=[],q=$.trim(k.name);o.push(h),l.sorting&&(h='<li class="ui-menu-item" role="presentation"><a class="g-menu-item" tabindex="0" role="menuitem" data-value="sortasc"><table class="ui-sysmng-table"><tr><td class="menu_icon"><span class="'+r+" "+s.icon_sort_asc+'"></span></td><td class="menu_text">'+m.sortasc+"</td></tr></table></a></li>",h+='<li class="ui-menu-item" role="presentation"><a class="g-menu-item" tabindex="0" role="menuitem" data-value="sortdesc"><table class="ui-sysmng-table"><tr><td class="menu_icon"><span class="'+r+" "+s.icon_sort_desc+'"></span></td><td class="menu_text">'+m.sortdesc+"</td></tr></table></a></li>",o.push(h)),l.columns&&(h='<li class="ui-menu-item divider" role="separator"></li>',h+='<li class="ui-menu-item" role="presentation"><a class="g-menu-item" tabindex="0" role="menuitem" data-value="columns"><table class="ui-sysmng-table"><tr><td class="menu_icon"><span class="'+r+" "+s.icon_columns+'"></span></td><td class="menu_text">'+m.columns+"</td></tr></table></a></li>",o.push(h)),l.filtering&&(h='<li class="ui-menu-item divider" role="separator"></li>',h+='<li class="ui-menu-item" role="presentation"><a class="g-menu-item" tabindex="0" role="menuitem" data-value="filtering"><table class="ui-sysmng-table"><tr><td class="menu_icon"><span class="'+r+" "+s.icon_filter+'"></span></td><td class="menu_text">'+m.filter+" "+n+"</td></tr></table></a></li>",o.push(h)),l.grouping&&(d=$.inArray(k.name,e.p.groupingView.groupField),h='<li class="ui-menu-item divider" role="separator"></li>',h+='<li class="ui-menu-item" role="presentation"><a class="g-menu-item" tabindex="0" role="menuitem" data-value="grouping"><table class="ui-sysmng-table"><tr><td class="menu_icon"><span class="'+r+" "+s.icon_group+'"></span></td><td class="menu_text">'+(-1!==d?m.ungrouping:m.grouping+" "+n)+"</td></tr></table></a></li>",o.push(h)),l.freeze&&(f=!k.frozen||!e.p.frozenColumns,h='<li class="ui-menu-item divider" role="separator"></li>',h+='<li class="ui-menu-item" role="presentation"><a class="g-menu-item" tabindex="0" role="menuitem" data-value="freeze"><table class="ui-sysmng-table"><tr><td class="menu_icon"><span class="'+r+" "+s.icon_freeze+'"></span></td><td class="menu_text">'+(f?m.freeze+" "+n:m.unfreeze)+"</td></tr></table></a></li>",o.push(h));for(var
t
in
e.p.colMenuCustom)if(e.p.colMenuCustom.hasOwnProperty(t)){var
u=e.p.colMenuCustom[t],v=u.exclude.split(",");v=$.map(v,function(a){return $.trim(a)}),(u.colname===q||"_all_"===u.colname&&-1===$.inArray(q,v))&&(j='<li class="ui-menu-item divider" role="separator"></li>',h='<li class="ui-menu-item" role="presentation"><a class="g-menu-item" tabindex="0" role="menuitem" data-value="'+u.id+'"><table class="ui-sysmng-table"><tr><td class="menu_icon"><span class="'+r+" "+u.icon+'"></span></td><td class="menu_text">'+u.title+"</td></tr></table></a></li>","last"===u.position?(o.push(j),o.push(h)):"first"===u.position&&(o.unshift(j),o.unshift(h)))}if(o.unshift(g),o.push(i),$("#gbox_"+e.p.id).append(o.join("")),$("#column_menu").addClass("ui-search-menu modal-content column-menu jqgrid-column-menu ui-menu "+s.menu_widget).css({left:b,top:c}),"ltr"===e.p.direction){var
...
define&&define.amd?define(["jquery","./grid.base","./grid.sysmng"],a):a(jQuery)}(function(a){"use strict";var
...
M="rtl"===s.p.direction,N=M?"nData":"pData",O=M?"pData":"nData",P="<a id='"+N+"' class='fm-button "+h.button+"'><span class='"+h.icon_base+" "+g.icon_prev+"'></span></a>",Q="<a id='"+O+"' class='fm-button "+h.button+"'><span class='"+h.icon_base+" "+g.icon_next+"'></span></a>",R="<a id='sData' class='fm-button "+h.button+"'>"+d.bSubmit+"</a>",S="<a id='cData' class='fm-button "+h.button+"'>"+d.bCancel+"</a>",T=a.isArray(b[s.p.id].buttons)?a.jgrid.buildButtons(b[s.p.id].buttons,R+S,h):R+S,U="<table style='height:auto' class='EditTable ui-sysmng-table' id='"+z+"_2'><tbody><tr><td colspan='2'><hr class='"+h.content+"' style='margin:1px'/></td></tr><tr id='Act_Buttons'><td class='navButton'>"+(M?Q+P:P+Q)+"</td><td class='EditButton'>"+T+"</td></tr>";if(U+="</tbody></table>",E>0){var
...
u="<a id='dData' class='fm-button "+h.button+"'>"+d.bSubmit+"</a>",v="<a id='eData' class='fm-button "+h.button+"'>"+d.bCancel+"</a>",w=a.isArray(b[e.p.id].buttons)?a.jgrid.buildButtons(b[e.p.id].buttons,u+v,h):u+v,x=a(".ui-jqgrid").css("font-size")||"11px";if(t+="<table class='EditTable ui-sysmng-table' id='"+o+"_2'><tbody><tr><td><hr class='"+h.content+"' style='margin:1px'/></td></tr><tr><td class='DelButton EditButton'>"+w+"</td></tr></tbody></table>",d.gbox="#gbox_"+a.jgrid.jqID(l),a.jgrid.createModal(q,t,b[e.p.id],"#gview_"+a.jgrid.jqID(e.p.id),a("#gview_"+a.jgrid.jqID(e.p.id))[0],null,{"font-size":x}),a(".fm-button","#"+o+"_2").hover(function(){a(this).addClass(h.hover)},function(){a(this).removeClass(h.hover)}),d.delicon=a.extend([!0,"left",g.icon_del],b[e.p.id].delicon),d.cancelicon=a.extend([!0,"left",g.icon_cancel],b[e.p.id].cancelicon),!0===d.delicon[0]&&a("#dData","#"+o+"_2").addClass("right"===d.delicon[1]?"fm-button-icon-right":"fm-button-icon-left").append("<span class='"+h.icon_base+" "+d.delicon[2]+"'></span>"),!0===d.cancelicon[0]&&a("#eData","#"+o+"_2").addClass("right"===d.cancelicon[1]?"fm-button-icon-right":"fm-button-icon-left").append("<span class='"+h.icon_base+" "+d.cancelicon[2]+"'></span>"),a("#dData","#"+o+"_2").click(function(){var
...
define&&define.amd?define(["jquery","./grid.base","./grid.sysmng"],a):a(jQuery)}(function(a){"use strict";a.fn.jqFilter=function(b){if("string"==typeof
b){var
...
s=d.p.colModel[p],t=a.extend({},s.searchoptions);for(t.sopt||(t.sopt=[],t.sopt[0]="select"===s.stype?"eq":b.defaultSearch),a.each(b.odata,function(){o.push(this.oper)}),p=0;p<t.sopt.length;p++)-1!==(j=a.inArray(t.sopt[p],o))&&(g=n===b.odata[j].oper?i.highlight:"",m+='<li class="ui-menu-item '+g+'" role="presentation"><a class="'+i.cornerall+' g-menu-item" tabindex="0" role="menuitem" value="'+b.odata[j].oper+'" oper="'+b.operands[b.odata[j].oper]+'"><table class="ui-sysmng-table"><tr><td width="25px">'+b.operands[b.odata[j].oper]+"</td><td>"+b.odata[j].text+"</td></tr></table></a></li>");m+="</ul>",a("body").append(m),a("#sopt_menu").addClass("ui-menu "+h.menu_widget),a("#sopt_menu > li > a").hover(function(){a(this).addClass(i.hover)},function(){a(this).removeClass(i.hover)}).click(function(){var
...
define&&define.amd?define(["jquery","./grid.base","./grid.sysmng"],a):a(jQuery)}(function(a){"use strict";a.jgrid.inlineEdit=a.jgrid.inlineEdit||{},a.jgrid.extend({editRow:function(b,c,d,e,f,g,h,i,j){var
...
e,f,g,h,i,m,n=a("<table class='"+j.rowTable+" ui-sysmng-table'><tbody></tbody></table>"),o=a("<tr></tr>");for(g=0;g<d.p.subGridModel[0].name.length;g++)e=a("<th class='"+j.headerBox+" ui-th-subgrid ui-th-column ui-th-"+d.p.direction+"'></th>"),a(e).html(d.p.subGridModel[0].name[g]),a(e).width(d.p.subGridModel[0].width[g]),a(o).append(e);if(a(n).append(o),b&&(i=d.p.jsonReader.subgrid,void
