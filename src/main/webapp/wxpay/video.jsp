...
<div class="container-fluid">
    ...
    <div class="row" style="height: 10%;">
        <h1  style="text-align: center;color: #ff291f;">💨视频大小：<span id="filesize">0</span>Mb,视频时长：<span id="timeLength">0</span></h1>
    </div>
    ...
    <div class="row" style="height: 20%;">
        <p class="lead" style="color: #ffeb26;font-size: 30px;">由于网络波动原因，出现视频卡顿无法播放等情况时，可等待缓冲或刷新页面重试！</p>
    </div>
</div>
