                                ...
                                <div class="row">
                                    <div class="col-xs-6">
                                        ...
                                        <div>
                                            ...
                                            订单数量：<span style="color: #ff7a12;font-size: 22px;" id="orderNum">0</span> 单；
                                            今日总额：<span style="color: #ff7a12;font-size: 22px;" id="todayTurnover">0</span> ${CurrenccyName}；
                                            盈利：<span style="color: #ff7a12;font-size: 22px;" id="todayIncome">50</span> ${CurrenccyName}；
                                            </span>
...
<script type="text/javascript" src="${jsDir}/orderinfo/orderinfo.js"></script>
