...
<head>
    ...
    <link href="${vendorDir}/treeview/bootstrap-treeview.min.css" rel="stylesheet">
    <style type="text/css">
        #userList_info{
            float: left;
        }
        ...
        <div class="panel-body">
            <!-- search star -->
                <div class="form-group" style="float: right;">
                    <button id="accredit" class="btn btn-primary btn-xs p310" onclick="roleMng.showAccreditModal()"><i class="icon_heart"></i> 授权</button>
                    <button id="add" class="btn btn-primary btn-xs p310" onclick="roleMng.add()"><i class="icon_plus_alt"></i> 新增</button>
                    <button id="edit" class="btn btn-primary btn-xs p310" onclick="roleMng.edit()"><i class="icon_pencil-edit_alt"></i> 编辑</button>
                    <button id="delete" class="btn btn-primary btn-xs p310" onclick="roleMng.showSureModal()"><i class="icon_trash"></i> 删除</button>
                    <button id="resh" class="btn btn-primary btn-xs p310" onclick="roleMng.refresh()"><i class="icon_refresh"></i> 刷新</button>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer" style="text-align: center;" >
                <button type="button" class="btn btn-primary" onclick="roleMng.addOrUpdate()">提交</button>
...
<div class="modal" id="sureModal" tabindex="-1" role="dialog" data-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer" style="text-align: center;" >
                <button type="button" class="btn btn-primary" onclick="roleMng.delete()">确认</button>
                <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal -->
...
<div class="modal" id="accreditModal" tabindex="-1" role="dialog" data-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer" style="text-align: center;" >
                <button type="button" class="btn btn-primary" onclick="roleMng.accredit()">确认</button>
                <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal -->
...
<script type="text/javascript" src="${vendorDir}/treeview/bootstrap-treeview.min.js"></script>
<script type="text/javascript" src="${jsDir}/rolemng/roleMng.js"></script>
